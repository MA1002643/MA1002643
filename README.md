...
<div align="center">
  <picture>
    ...
    <img src="./assets/activity-feed-light.svg" alt="Recent GitHub activity — refreshed daily: Pushed commits to MA1002643/plenary (yesterday); Pushed commits to MA1002643/dhun (yesterday); Pushed commits to MA1002643/culina (yesterday); Pruned a branch in MA1002643/colophon (yesterday); Pushed commits to MA1002643/colophon (yesterday); Merged a pull request in MA1002643/colophon (yesterday); Created a branch in MA1002643/colophon (yesterday); Created a branch in MA1002643/theabdullahfolio (3d ago)" width="100%">
  </picture>
</div>
<!--RECENT_ACTIVITY:end-->
...
<div align="center">
  ...
  <!-- LANG-TIME:START -->
  <picture><source media="(prefers-color-scheme: dark)" srcset="./assets/lang-time-dark.svg"><img src="./assets/lang-time-light.svg" alt="Daily coding time by language over the past 7 days — JavaScript 19 hrs 42 mins (51.4%), Markdown 12 hrs 34 mins (32.8%), Bash 1 hrs 28 mins (3.8%), Other 1 hrs 11 mins (3.1%), CSS 44 mins (1.9%), Python 41 mins (1.8%), Text 30 mins (1.3%). Total 38 hrs 21 mins. Updated 2026-08-07." width="460" height="192"></picture>
  <!-- LANG-TIME:END -->
</div>
